...
public class MusicDiscs {
    ...
    private static final MusicDiscEntry[] MUSIC_DISC_LIST = {
        // Chiru-san
        new MusicDiscEntry("chiru_san_ayumi",                   "Chiru-san",                  "Ayumi",                                     263, "chiru_san_mendacity"),
        ...
        // Glitch Cat
        new MusicDiscEntry("glitch_cat_whisker",                "Glitch Cat",                 "Whisker",                                   195),
        new MusicDiscEntry("glitch_cat_chaos_cannon",           "Glitch Cat (feat. Quetzol)", "Chaos Cannon",                              260),
        new MusicDiscEntry("glitch_cat_wait_for_me",            "Glitch Cat",                 "Wait For Me",                               263),
        new MusicDiscEntry("glitch_cat_euphoria",               "Glitch Cat",                 "Euphoria",                                  212),
        new MusicDiscEntry("glitch_cat_interconnected",         "Glitch Cat",                 "Interconnected",                            170, "glitch_cat_euphoria"), // TODO: Possibly add own texture.
        new MusicDiscEntry("glitch_cat_garota_gato",            "Glitch Cat",                 "Garota Gato",                               236),
        new MusicDiscEntry("glitch_cat_spirit",                 "Glitch Cat",                 "Spirit",                                    201),
